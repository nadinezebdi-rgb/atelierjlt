// Catalogue Atelier Ginette - photos artisanales réelles fournies par la maison.
// Prix en EUR. Slugs stables.

export const CATEGORIES = [
  { slug: 'sacs',              name: 'Sacs Crochet',      tagline: 'Chaque maille racontée à la main', color: 'brique' },
  { slug: 'bougies',           name: 'Bougies',           tagline: 'Parfums et cristaux, coulés à la main', color: 'terracotta' },
  { slug: 'bijoux',            name: 'Bijoux',            tagline: 'Petites pièces, grande présence', color: 'wood' },
  { slug: 'decoration',        name: 'Décoration',        tagline: "L'âme d'un intérieur", color: 'plantes' },
  { slug: 'nouveautes',        name: 'Nouveautés',        tagline: 'Les dernières créations', color: 'sage' },
  { slug: 'editions-limitees', name: 'Éditions limitées', tagline: 'Numérotées, jamais reproduites', color: 'brique' },
]
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    images: [BAGS, IMAGES.interior1, IMAGES.interior2],
  ...
  },
  {
    ...
    images: [P('plaid-01.jpeg'), P('lifestyle-plaid.jpeg'), P('ambiance-lin.jpeg'), P('ambiance-canape.jpeg'), P('plaid-02.jpeg'), P('plaid-03.jpeg')],
  ...
  // ============ NOUVEAUX COUSSINS CROCHET ============
  {
    id: 'p-22', slug: 'coussin-crochet-ecru', name: 'Coussin Crochet — Écru',
    category: 'decoration', collection: 'boreale', price: 118,
    material: 'Trapilho (coton tricot recyclé)', color: 'Écru naturel', style: 'Rond & moelleux',
    dimensions: 'Ø 42 cm — épaisseur 12 cm', weight: '620 g', makingTime: '9 heures',
    stock: 6, isNew: true, isLimited: false,
    tags: ['coussin', 'crochet', 'nouveauté'],
    images: [P('lifestyle-plaid.jpeg'), P('ambiance-lin.jpeg'), P('deco-02.jpeg'), P('plaid-01.jpeg')],
    story: "Un coussin rond crocheté à la main en trapilho écru — un fil épais issu de coton tricot recyclé. Neuf heures de crochet en mailles serrées pour un rendu dense et généreux. Se pose au pied d'un lit, sur un banc, dans un fauteuil. Se glisse contre un dos en fin de journée.",
    care: 'Aspirer délicatement. Nettoyage à sec ponctuel.',
  },
  {
    id: 'p-23', slug: 'coussin-crochet-bordeaux', name: 'Coussin Crochet — Bordeaux',
    category: 'decoration', collection: 'heritage', price: 128,
    material: 'Trapilho (coton tricot recyclé)', color: 'Bordeaux profond', style: 'Rond & moelleux',
    dimensions: 'Ø 42 cm — épaisseur 12 cm', weight: '640 g', makingTime: '9 heures',
    stock: 4, isNew: true, isLimited: true,
    tags: ['coussin', 'crochet', 'nouveauté', 'édition limitée'],
    images: [P('ambiance-lin.jpeg'), P('lifestyle-plaid.jpeg'), P('plaid-02.jpeg'), P('deco-02.jpeg')],
    story: "Le bordeaux profond, presque grenat sous la lumière du matin. Un coussin rond crocheté main en trapilho recyclé, dense et rassurant. Se marie au vert mousse du Plaid Sylvestre, au lin naturel, ou seul pour trancher la neutralité d'une pièce. Édition limitée à 20 exemplaires.",
    care: 'Aspirer délicatement. Nettoyage à sec.',
  },
]
