...
const items = [
  { icon: Hammer, title: 'Fabrication artisanale', text: 'Chaque pièce prend forme dans nos mains, pas en série.' },
  { icon: Flag, title: 'Créations françaises', text: 'Atelier basé dans la Drôme. Made in France assumé.' },
  { icon: Sprout, title: 'Matières sélectionnées', text: 'Coton recyclé, grès, laines nobles, bois massifs.' },
  { icon: Diamond, title: 'Pièces uniques', text: 'Aucune création n’est parfaitement identique.' },
  { icon: Gift, title: 'Emballage soigné', text: 'Un rituel de déballage pensé pour être gardé.' },
]
          ...
          {items.map((it, i) => (
            ...
            >
              <div className="h-12 w-12 rounded-full bg-ivory border border-linen mx-auto flex items-center justify-center mb-4">
                <it.icon className="h-5 w-5 text-terracotta" strokeWidth={1.3} />
              </div>
